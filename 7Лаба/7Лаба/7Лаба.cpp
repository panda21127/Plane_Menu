...
int main()
{
	...
	while (flag != 0)
	{
		...
		cout << "Enter 5 to exit                                     "; SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 2); cout << "   2003 AO YK \"Aeropalka\"" << endl; SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
		cout << "Input:     ";
		number = onlyNumbers();
		switch (number)
		{
